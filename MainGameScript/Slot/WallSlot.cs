...
public class WallSlot : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        if (icon.sprite != null)
        {
            ...
            if (eventData.pointerCurrentRaycast.gameObject.GetComponent<WallSlot>() != null)
            {
    ...
    private void MoveOrSwapItems(WallSlot targetSlot)
    {
