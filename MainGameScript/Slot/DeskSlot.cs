...
public class DeskSlot : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        if (icon.sprite != null)
        {
            ...
            if (eventData.pointerCurrentRaycast.gameObject.GetComponent<DeskSlot>() != null)
            {
    ...
    private void MoveOrSwapItems(DeskSlot targetSlot)
    {
