...
public class DialogListManager3BadEnding : MonoBehaviour
{
    ...
    public GameObject dialogScene2BadEnding;
    ...
    private void Awake()
    {
        ...
        dialogScene2BadEnding = GameObject.FindGameObjectWithTag("DialogScene2BadEnding");
    ...
    {
        string[] dialogs = new string[] { "(他看起来心不在焉，沉默了许久)",
            "老板：青蛙先生？你好？",
            "青蛙：哦哦哦，你好，那个....我是来退房的，谢谢你安排的房间，再见" };
        foreach (string dialog in dialogs)
        {
    ...
    IEnumerator LoadSceneWithFadeEffect(float _delay)
    {
        ...
        dialogScene2BadEnding.SetActive(false);
