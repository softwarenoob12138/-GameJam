...
public class DialogListManager3GoodEnding : MonoBehaviour
{
    ...
    public GameObject dialogScene2GoodEnding;
    ...
    private void Awake()
    {
        ...
        dialogScene2GoodEnding = GameObject.FindGameObjectWithTag("DialogScene2GoodEnding");
    ...
    {
        string[] dialogs = new string[] { "(青蛙的脸上带着笑容，看似阴霾已经一扫而空)老板，我是来退房的",
            "老板：好的，让我办理一下手续",
            "青蛙：话说起来，这周边有什么比较适合看星星的地方吗？我突然有点灵感",
        "老板：这样吗？那我会推荐泥塘，那附近的视野非常好",
        "青蛙：好嘞，谢谢你了，不得不说捕梦网旅店确实有着一些魔力呢！"};
        foreach (string dialog in dialogs)
        {
    ...
    IEnumerator LoadSceneWithFadeEffect(float _delay)
    {
        ...
        dialogScene2GoodEnding.SetActive(false);
